  ...
  return (
    <div className="flex justify-start px-5 pt-8">
      <div className="flex flex-col flex-[2] items-start">
        ...
        <p className="py-5">Veyor Wellnes <span className="pl-3">${sessionDetail?.price.toFixed(2)}</span></p>
        ...
        <Button title="Schedule another Appointment" variant="SECONDARY" onClick={onCreateNewAppointment(navigate)} />
      </div>
      <div className="flex flex-col items-start flex-1 border-l-[1px] border-l-gray-300 pl-5 gap-3">
        <h2 className="text-left">Easily book and manage appointments with Veyor Wellness on your phone</h2>
        <p className="text-left">Get the mobile app by opening the camera on your phone, and scanning this QR code:</p>
      </div>
    </div>
  )
}

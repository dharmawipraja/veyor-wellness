...
describe('Date Utility Functions', () => {
  it('should getMonthIndex should return the correct index for a given month', () => {
  ...
  it('should getMonthName should return the correct month name for a given date', () => {
  ...
  it('should addMonths should correctly add months to a date', () => {
  ...
  it('should generateMonthYear should return an array of month-year strings', () => {
    const result = generateMonthYear(12);
    expect(result.length).toBe(13);
    expect(result[0]).toMatch(/^\w+ \d{4}$/);
  });

  it('should formatDate should return formatted date strings', () => {
    const date = new Date(2023, 0, 1);
